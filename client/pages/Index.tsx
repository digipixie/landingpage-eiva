          ...
          <div className="relative max-w-7xl mx-auto">
            <div className="text-center mb-14">
              ...
              <p className="text-xl text-gray-800 font-montserrat max-w-2xl mx-auto">
                Please update your password within 24 hours
                <br />
              ...
              <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
                ...
                <form className="space-y-6">
                  <div>
                    <label
                      htmlFor="password"
                      className="block text-sm font-medium text-gray-500 font-montserrat mb-2"
                    >
                      Password
                    </label>
                    <input
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-xl p-8">
              ...
              <div className="space-y-4">
                <div className="flex justify-between py-2 border-b border-gray-100">
                  <span className="font-medium text-gray-500 font-montserrat">
                    Account Email:
                  </span>
                ...
                <div className="flex justify-between py-2">
                  ...
                  <span className="text-red-600 font-bold font-montserrat">
            ...
            <div className="bg-yellow-50 border-l-4 border-cebu-yellow rounded-lg shadow-xl p-6">
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <p className="text-red-800 font-semibold text-sm font-montserrat">
                  ⚠️ This booking will be cancelled if verification is not
                  completed by December 14, 2024 • 11:59 PM
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 px-6 lg:px-17 bg-cebu-blue text-white">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-lg font-montserrat opacity-90 mb-12">
              Our security team is available 24/7 to help you with the
              verification process
            </p>
