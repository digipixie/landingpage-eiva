...
import { ChevronDown, Search, User, Globe, DollarSign, Info } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-2">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold font-montserrat">Travel Advisory:</span>
              <span className="font-montserrat">Power Bank Usage and Carriage Guidelines</span>
            </div>
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-1">
                <button className="p-1">
                  <img src="https://api.builder.io/api/v1/image/assets/TEMP/fe14f4aeec14575a0f13c749dfcd2032814dfe1c?width=36" alt="Previous" className="w-4 h-4" />
                </button>
                <button className="p-1">
                  <img src="https://api.builder.io/api/v1/image/assets/TEMP/d75ebd537648fef1244abf5e30affefcd52300d7?width=36" alt="Next" className="w-4 h-4" />
                </button>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex items-center justify-between h-18">
            ...
            <nav className="hidden lg:flex items-center space-x-8">
              <a href="#" className="text-cebu-blue-600 font-bold font-montserrat text-sm hover:text-cebu-blue-500 transition-colors px-6 py-6">
                Book
              </a>
              <a href="#" className="text-cebu-blue-600 font-bold font-montserrat text-sm hover:text-cebu-blue-500 transition-colors px-6 py-6">
                Manage
